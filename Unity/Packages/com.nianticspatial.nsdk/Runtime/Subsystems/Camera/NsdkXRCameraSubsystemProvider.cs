...
{
    /// <summary>
    /// An XRCameraSubsystem provider that uses the Nsdk native camera subsystem
    /// implementation to acquire camera images.
    /// </summary>
    internal class NsdkXRCameraSubsystemProvider : XRCameraSubsystem.Provider
    {
        /// <summary>
        ...
        /// <summary>
        /// Constructs the Nsdk camera subsystem provider.
        /// </summary>
        public NsdkXRCameraSubsystemProvider()
        ...
        /// </summary>
        protected NsdkXRCameraSubsystemProvider(bool supportsTextureDescriptors)
        {
        ...
        public override bool TryAcquireLatestCpuImage(out XRCpuImage.Cinfo cameraImageCinfo)
        {
            ...
            var success = NsdkCpuImageApi.Instance.TryAddManagedXRCpuImage(
                // Planes data
                new[] { plane0, plane1 },
            ...
            Allocator allocator)
        {
                ...
                TryAcquireLatestCpuImage(out var cinfo))
            {
                ...
                for (var planeIdx = 0; planeIdx < numPlanes; planeIdx++)
                {
                    ...
                    textureDescriptors[planeIdx] = XRTextureDescriptorUtils.Create(
