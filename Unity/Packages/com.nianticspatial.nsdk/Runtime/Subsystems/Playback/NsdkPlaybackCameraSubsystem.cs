...
{
    [Preserve]
    public class NsdkPlaybackCameraSubsystem : XRCameraSubsystem, IPlaybackDatasetUser
    {
        private const string BeforeOpaquesBackgroundShaderName = "Unlit/NsdkPlaybackBackground";
        private const string NsdkImageConversionShaderName = "Unlit/NsdkImageConversion";

        public static readonly string[] BackgroundShaderNames =
            new[] { BeforeOpaquesBackgroundShaderName, NsdkImageConversionShaderName };
        ...
        private class NsdkPlaybackProvider : Provider, IPlaybackDatasetUser
        {
            // TODO: Support URP
            ...
            public override XRCpuImage.Api cpuImageApi => NsdkCpuImageApi.Instance;
            ...
            public override bool TryAcquireLatestCpuImage(out XRCpuImage.Cinfo cinfo)
            {
                ...
                var nsdkCpuImageApi = (NsdkCpuImageApi)cpuImageApi;

#if NIANTICSPATIAL_NSDK_YUV_PLAYBACK
                // Convert RGB to YUV
                ...
                try
                {
                    // Copy the YUV data to the NsdkCpuImageApi repository
                    return nsdkCpuImageApi.TryAddManagedXRCpuImage(planes, sizes, _currentFrame.Frame.width,
                ...
                return nsdkCpuImageApi.TryAddManagedXRCpuImage
                (
                    rgbDataPtr,
            ...
            )
            {
                ...
                arr[0] = XRTextureDescriptorUtils.Create(
            ...
            public override XRShaderKeywords GetShaderKeywords2() => new(
                new ReadOnlyList<string>(_legacyRPEnabledMaterialKeywords),
                new ReadOnlyList<string>(_legacyRPDisabledMaterialKeywords)
            );
