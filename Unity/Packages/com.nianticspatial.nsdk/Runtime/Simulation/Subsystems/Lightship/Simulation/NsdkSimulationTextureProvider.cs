...
namespace NianticSpatial.NSDK.AR.Simulation
{
    ...
    /// </summary>
    internal abstract class NsdkSimulationTextureProvider : MonoBehaviour
    {
        /// <summary>
        /// Event that is invoked when a new frame is received.
        /// </summary>
        internal event Action<NsdkCameraTextureFrameEventArgs> FrameReceived;
        ...
        internal static TProvider AddToCamera<TProvider>(Camera simulationCamera, Camera xrCamera)
            where TProvider : NsdkSimulationTextureProvider
        {
        ...
        private void PublishFrame()
        {
            ...
            FrameReceived?.Invoke(
                new NsdkCameraTextureFrameEventArgs(timestampNs, projectionMatrix, displayMatrix, intrinsics,
                    _outputTexture));
        }
        ...
        internal bool TryGetTextureDescriptor(out XRTextureDescriptor planeDescriptor)
        {
            ...
            planeDescriptor = XRTextureDescriptorUtils.Create(
                nativePtr,
