...
namespace NianticSpatial.NSDK.AR.Simulation
{
    ...
    /// </summary>
    internal class NsdkSimulationDevice : MonoBehaviour
    {
        private static NsdkSimulationDevice s_instance;
        ...
        private static Quaternion s_cameraSensorToGameViewRotation
        {
            get
            {
                return NsdkSimulationEditorUtility.GetGameViewAspectRatio() >= 1.0
        ...
        internal void SendPoseToInputProvider(Pose pose)
        {
            ...
            NsdkInputProvider.SetPose(position, displayToLocal, (uint)poseAsMatrixOfCamera.inverse.GetScreenOrientation());
        }
        ...
        private void ApplyOrientationCorrection()
        {
            ...
            {
                var aspectRatio = NsdkSimulationEditorUtility.GetGameViewAspectRatio();
        ...
        internal static NsdkSimulationDevice GetOrCreateSimulationCamera()
        {
            if (!s_instance)
            {
                ...
                s_instance = xrSimulationCamera.AddComponent<NsdkSimulationDevice>();

                var cameraParentGo = new GameObject("NsdkSimulationCameras");
                ...
                var rgbCameraGo = new GameObject("NsdkSimulationRgbCamera");
                ...
                s_instance._lastAspectRatio = NsdkSimulationEditorUtility.GetGameViewAspectRatio();
            }
