...
{
    internal class NsdkSimulationDepthTextureProvider : NsdkSimulationTextureProvider
    {
        // Shader properties
        ...
        protected override bool OnAllocateResources(out RenderTexture targetTexture, out Texture2D outputTexture)
        {
            ...
            var shader = Shader.Find("Custom/NsdkSimulationDepthShader");
            if (shader == null)
            {
                targetTexture = null;
                outputTexture = null;
        ...
        internal bool TryGetConfidenceTextureDescriptor(out XRTextureDescriptor depthConfidenceDescriptor)
        {
            ...
            depthConfidenceDescriptor = XRTextureDescriptorUtils.Create(
                _confidencePointer,
                _confidenceTexture.width,
                _confidenceTexture.height,
                _confidenceTexture.mipmapCount,
                _confidenceTexture.format,
                s_environmentDepthTextureId,
                0,
