...
namespace NianticSpatial.NSDK.AR.Occlusion.Features
{
    ...
    internal sealed class OcclusionMesh : OcclusionComponent
    {
        ...
        /// </summary>
        public const string RequiredShaderName = "Nsdk/OcclusionMesh";

        // Components
        private XRCameraSubsystem _cameraSubsystem;
        private NsdkOcclusionSubsystem _nsdkOcclusionSubsystem;
        private NsdkPlaybackOcclusionSubsystem _playbackOcclusionSubsystem;
        ...
        public void Configure(XROcclusionSubsystem occlusionSubsystem, XRCameraSubsystem cameraSubsystem)
        {
            ...
            _nsdkOcclusionSubsystem = occlusionSubsystem as NsdkOcclusionSubsystem;
            _playbackOcclusionSubsystem = occlusionSubsystem as NsdkPlaybackOcclusionSubsystem;
        ...
        protected override void OnUpdate(Camera camera)
        {
            ...
            {
                _intrinsics = _nsdkOcclusionSubsystem.LatestIntrinsicsMatrix ?? Matrix4x4.identity;
                _extrinsics = _nsdkOcclusionSubsystem.LatestExtrinsicsMatrix ?? Matrix4x4.identity;
            }
