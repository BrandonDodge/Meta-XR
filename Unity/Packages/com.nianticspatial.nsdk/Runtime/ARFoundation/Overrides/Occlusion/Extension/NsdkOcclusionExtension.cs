...
namespace NianticSpatial.NSDK.AR.Occlusion
{
    ...
    /// NSDK's implementation of <see cref="XROcclusionSubsystem"/>.
    /// </summary>
    [PublicAPI("apiref/Niantic/Lightship/AR/Occlusion/NsdkOcclusionExtension/")]
    ...
    public partial class NsdkOcclusionExtension : CompositeRenderer
    {
        ...
        [Range(1, 90)]
        private uint _targetFrameRate = NsdkOcclusionSubsystem.MaxRecommendedFrameRate;
        ...
        /// </summary>
        protected override string RendererName => "NsdkOcclusionExtension Pass (LegacyRP)";
        ...
        {
#if !UNITY_EDITOR && NIANTICSPATIAL_NSDK_ML2_ENABLED
        ...
        /// <summary>
        /// Determines whether the occlusion manager is using the NSDK Occlusion Subsystem.
        /// </summary>
        private bool IsUsingNsdkOcclusionSubsystem => _nsdkOcclusionSubsystem != null;

        /// <summary>
        /// Determines whether the <see cref="TargetFrameRate"/> API is supported with the current configuration.
        /// </summary>
        public bool SupportsTargetFrameRate => IsUsingNsdkOcclusionSubsystem;
        ...
        {
            get => IsUsingNsdkOcclusionSubsystem ? _nsdkOcclusionSubsystem.TargetFrameRate : _targetFrameRate;
            set
            {
                _targetFrameRate = value <= 0u ? NsdkOcclusionSubsystem.MaxRecommendedFrameRate : value;
                if (IsUsingNsdkOcclusionSubsystem)
                {
                    _nsdkOcclusionSubsystem.TargetFrameRate = _targetFrameRate;
                }
            }
        }
        ...
        public Matrix4x4? LatestIntrinsicsMatrix
        {
            get
            {
                ...
                if (_nsdkOcclusionSubsystem != null)
                {
                    return _nsdkOcclusionSubsystem.LatestIntrinsicsMatrix;
                }

                // Using playback depth (possibly cropped aspect ratio)
                if (_nsdkPlaybackOcclusionSubsystem != null)
                {
                    return _nsdkPlaybackOcclusionSubsystem.LatestIntrinsicsMatrix;
                }
        ...
        public Matrix4x4? LatestExtrinsicsMatrix
        {
            get
            {
                ...
                if (_nsdkOcclusionSubsystem != null)
                {
                    return _nsdkOcclusionSubsystem.LatestExtrinsicsMatrix;
                }

                // Using playback depth (pose is associated with the depth prediction)
                if (_nsdkPlaybackOcclusionSubsystem != null)
                {
                    return _nsdkPlaybackOcclusionSubsystem.LatestExtrinsicsMatrix;
                }
        ...
        public bool BypassOcclusionManagerUpdates
        {
            ...
            set
            {
                ...
                // Not allowed without using the NSDK Occlusion Subsystem
                if (!IsUsingNsdkOcclusionSubsystem)
                {
                    // Cancel the request
                ...
                // Apply the setting
                if (_nsdkOcclusionSubsystem.RequestDisableFetchTextureDescriptors !=
                    disableFetchTextureDescriptors)
                {
                    _nsdkOcclusionSubsystem.RequestDisableFetchTextureDescriptors = disableFetchTextureDescriptors;
                }

                _currentBypassOcclusionManagerUpdates =
                    _nsdkOcclusionSubsystem.RequestDisableFetchTextureDescriptors;
            }
        }
        ...
        private void HandleOcclusionManagerSettings()
        {
            ...
            var preferredNsdkSetting =
                isRenderingActive ? OcclusionPreferenceMode.NoOcclusion : _preferredManagerSetting.Value;

            // Apply the setting
            if (_occlusionManager.requestedOcclusionPreferenceMode != preferredNsdkSetting)
            {
                _occlusionManager.requestedOcclusionPreferenceMode = preferredNsdkSetting;
            }
        ...
        private void HandleOcclusionDistance()
        {
            ...
            if (OcclusionDistanceMode == OptimalOcclusionDistanceMode.Static || !IsUsingNsdkOcclusionSubsystem)
            {
                return;
            }
        ...
        private bool TryInitialize()
        {
            ...
            _nsdkOcclusionSubsystem = null;
            _nsdkPlaybackOcclusionSubsystem = null;
            ...
            if (_occlusionSubsystem == null)
            {
                Log.Warning
                (
                    $"Destroying {typeof(NsdkOcclusionExtension).FullName} component because " +
