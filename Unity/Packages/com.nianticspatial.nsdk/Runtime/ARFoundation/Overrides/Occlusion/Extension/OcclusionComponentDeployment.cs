...
namespace NianticSpatial.NSDK.AR.Occlusion
{
    ...
    /// </summary>
    public partial class NsdkOcclusionExtension
    {
                ...
                case Suppression occlusionSuppression:
                    {
                        ...
                        if (TryGetComponent<ARSemanticSegmentationManager>(out var manager) ||
                            (manager = FindAnyObjectByType<ARSemanticSegmentationManager>()) != null)
                        {
                ...
                case Stabilization occlusionStabilization:
                    {
                        ...
                        if (_meshManager == null)
                        {
                            ...
                            _meshManager = FindAnyObjectByType<ARMeshManager>();
                        }
        ...
        public bool IsOcclusionSuppressionEnabled
        {
            ...
            set
            {
                ...
                {
                    // Execute the request
                    _currentOcclusionSuppressionEnabled =
                        value ? AddRenderComponent<Suppression>() : !RemoveRenderComponent<Suppression>();
                }
        ...
        {
            get { return _stabilizationThreshold; }
            set
            {
        ...
        {
            get { return GetRenderComponent<Stabilization>()?.Material; }
