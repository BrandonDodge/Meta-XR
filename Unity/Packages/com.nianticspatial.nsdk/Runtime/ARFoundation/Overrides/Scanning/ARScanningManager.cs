...
namespace NianticSpatial.NSDK.AR.Scanning
{
    ...
    [DefaultExecutionOrder(NsdkARUpdateOrder.ScanningManager)]
        ...
        : SubsystemLifecycleManager<XRScanningSubsystem, XRScanningSubsystemDescriptor, XRScanningSubsystem.Provider>
    {
        ...
        /// The Raycast Color Buffer for Scan Visualization.
        /// </value>
        private NsdkExternalTexture _raycastColorTextureInfo;
        ...
        /// The Raycast Normal Buffer for Scan Visualization.
        /// </value>
        private NsdkExternalTexture _raycastNormalTextureInfo;
        ...
        /// The Raycast Position Buffer for Scan Visualization.
        /// </value>
        private NsdkExternalTexture _raycastPositionTextureInfo;
        ...
        private static Texture2D GetRaycastTexture(NsdkExternalTexture texture)
        {
            if (texture == null)
            {
                return null;
            ...
            if (texture is not NsdkExternalTexture2D externalTexture2D)
            {
                Log.Info("Scanning Raycast texture needs to be a Texture2D, but instead is "
#if ARF_6_1_OR_NEWER
                    + $"{texture.Descriptor.textureType}.");
#else
        ...
        {
            return subsystem.GetFrameCount();
        }
        ...
        private void UpdateTexturesInfos()
        {
            ...
            {
                NsdkExternalTexture.CreateOrUpdate(ref _raycastColorTextureInfo, raycastBufferDescriptor);
                NsdkExternalTexture.CreateOrUpdate(ref _raycastNormalTextureInfo, normalBufferDescriptor);
                NsdkExternalTexture.CreateOrUpdate(ref _raycastPositionTextureInfo, positionTextureDescriptor);
            }
        }
