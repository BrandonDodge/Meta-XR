...
namespace NianticSpatial.NSDK.AR.Meshing
{
    /// <summary>
    /// This component allows configuration of the additional functionality available in
    /// NSDK's implementation of <see cref="XRMeshingSubsystem"/>.
    /// </summary>
    [RequireComponent(typeof(ARMeshManager))]
    [PublicAPI("apiref/Niantic/Lightship/AR/Meshing/NsdkMeshingExtension/")]
      ...
      private void OnValidate()
      {
        ...
        private bool ValidateSubsystem()
        {
            ...
            if (meshSubsystem == null)
            {
                Log.Warning
                (
                    "Destroying NsdkMeshingExtension component because " +
