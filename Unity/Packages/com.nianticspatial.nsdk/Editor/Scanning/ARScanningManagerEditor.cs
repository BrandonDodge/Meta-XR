    ...
    internal class ARScanningManagerEditor : UnityEditor.Editor
    {
        ...
        private static class Contents
        {
            ...
            public const string VisualizationDepthDisabledError =
                "Scanning visualization requires NSDK Depth to be enabled.";
            ...
            public const string DepthLimitedFpsWarning =
                ...
                "rate of the depth feature from its default of 10 FPS, add a NSDK Occlusion Extension component " +
        ...
        public override void OnInspectorGUI()
        {
            ...
            var lidarEnabled = NsdkSettings.Instance.PreferLidarIfAvailable;
            ...
            using (new EditorGUI.IndentLevelScope(1))
            {
                ...
                if (_enableVoxelVisualization.boolValue || _enableRaycastVisualization.boolValue)
                {
                    ...
                    var depthEnabled = NsdkSettings.Instance.UseNsdkDepth;
            ...
            if (lidarEnabled && !estimatedDepthRecordingEnabled)
            {
                if (!_triedLookingForOcclusionManager)
                {
                    ...
                    _occlusionManagerRef = FindFirstObjectByType<AROcclusionManager>();
                }
